...
class BrowserHistory {
    constructor(homepage) {
        ...
        this.current = this.browserHistory.head.next;
    }

    visit(url) {
        const newURL = new Node(url);
        newURL.next = this.browserHistory.tail;
    ...
    back(steps) {
        ...
        while (steps > 0 && this.current.prev.val !== null) {
    ...
    forward(steps) {
        while (steps > 0 && this.current.next.val !== null) {
